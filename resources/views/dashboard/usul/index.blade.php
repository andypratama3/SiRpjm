...
<div class="col-12">
    <div class="card">
        <div class="card-header mb-0 pt-3 pb-0">
            <h5 class="card-title">Halaman Usul</h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">
                                    ...
                                    <a href="{{ route('dashboard.usul.show', $usul->id) }}" class="btn btn-secondary btn-sm">Detail</a>
                                    @endcan
                                    @can('mengusulkan-edit')
                                        <a href="{{ route('dashboard.usul.edit', $usul->id) }}" class="btn btn-success btn-sm">Edit</a>
                                    @endcan
                                    @can('mengusulkan-delete')
                                    <a href="#" data-id="{{ $usul->id }}" class="btn btn-danger btn-sm delete">
                                        Hapus
                                        <form action="{{ route('dashboard.usul.destroy', $usul->id) }}"
