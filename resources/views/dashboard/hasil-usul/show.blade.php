...
@section('title', 'Detail Hasil Usul')
@section('content')

<div class="col-md-12">
    <div class="card">
        <div class="card-header mb-0 pt-3 pb-0">
            <h5 class="card-title">Halaman Detail Hasil Usul</h5>
        </div>
            ...
            <div class="row">
                <form>
                    ...
                    <div class="col-md-12 mt-4">
                        <a href="{{ route('dashboard.hasil.usul.index') }}" class="btn btn-danger btn-sm">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
